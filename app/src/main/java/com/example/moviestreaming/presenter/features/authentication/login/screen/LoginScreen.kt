package com.example.moviestreaming.presenter.features.authentication.login.screen
...
import com.example.moviestreaming.presenter.features.authentication.login.action.LoginAction
import com.example.moviestreaming.presenter.features.authentication.login.state.LoginState
        ...
        content = { paddingValues ->
            Column(
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(LoginAction.OnValueChange(value = it, type = InputType.EMAIL))
                    },
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(LoginAction.OnValueChange(value = it, type = InputType.PASSWORD))
                    },
                    keyboardOptions = KeyboardOptions(
                ...
                Text(
                    stringResource(R.string.label_forgot_password_login_screen),
                    style = TextStyle(
                        fontSize = 16.sp,
                        lineHeight = 22.4.sp,
                        fontFamily = UrbanistFamily,
                ...
                HorizontalDividerWithText(text = stringResource(id = R.string.label_or_login_screen))
